...
void __convention("regparm")sub_53f158(int32_t arg1, int16_t arg2 @ x87control, long double arg3 @ st0, int32_t arg4)
{
    // 第一条实际指令: int32_t edx
    int32_t edx
    int32_t var_4 = edx
    ...
    if (z)
        ...
        if (data_65a980 == 0)
            __startOneArgErrorHandling(1, 0x12, data_54f3b0, 0x5a0710, var_4)
            return 
    else
        int16_t x87control
        int16_t x87status_1
        ...
        if (data_65a980 == 0)
            ...
            if (arg1.w != 0x27f)
                ...
                if (arg1.w != 0)
                    ...
                    if (arg1.w != 0)
                        __startOneArgErrorHandling(8, 0x12, x87_r0, 0x5a0710, var_4)
                        return 
