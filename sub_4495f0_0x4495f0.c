...
int32_t* __convention("regparm")sub_4495f0(int32_t arg1, uint32_t arg2, void* arg3, int32_t* arg4)
{
    ...
    if (*eax_2 != 0)
        void var_24
        eax_2 = sub_448960(&var_24, arg2, arg3, arg4, &var_24, 0)
        ...
        if (eax_2 != 2)
            if (eax_2 == 1)
                ...
                sub_44e4d0(eax_2, &data_5559b1, "result == POWER_CAN_USE", 
                    "c:\ax2017\jams\shards\code\shardsgame.cpp", 0x817, "ExecutePlayPower")
