...
uint32_t __thiscallsub_4e7ad0(void* arg1, uint32_t arg2)
{
    ...
    if (result != 0)
        ...
        if (ecx u< *(arg1 + 0x3c))
            ...
            if (esi_2[0x92] == result)
                if (*esi_2 != 0)
                    sub_44e4d0(result, &data_5559b1, "bufferData->mBufferType == DX11BUFFER_VERTEX", 
                        "c:\ax2017\engine\windows\windowsdx11.cpp", 0x1c7, 
