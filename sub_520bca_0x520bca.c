...
int32_t __fastcallsub_520bca(int32_t* arg1)
{
    ...
    label_520caa:
        ...
        while (true)
            ...
            *(arg1 + 0x31) = eax_6.b
            ...
            switch (eax_4)
                case 0
                    eax_5 = __crt_stdio_output::output_processor<char,class __crt_stdio_output::stream_output_adapter<char>,class __crt_stdio_output::format_validation_base<char,class __crt_stdio_output::stream_output_adapter<char> > >::state_case_normal()
                case 1
                    arg1[0xa] = 0xffffffff
                    arg1[9] = 0
                    arg1[0xc].b = 0
                ...
                case 5
                    eax_5 = __crt_stdio_output::output_processor<char,class __crt_stdio_output::console_output_adapter<char>,class __crt_stdio_output::format_validation_base<char,class __crt_stdio_output::console_output_adapter<char> > >::state_case_precision(
                        arg1)
                case 6
                    eax_5 = sub_52121c(arg1)
                case 7
                    eax_5 = __crt_stdio_output::output_processor<char,class __crt_stdio_output::stream_output_adapter<char>,class __crt_stdio_output::format_validation_base<char,class __crt_stdio_output::stream_output_adapter<char> > >::state_case_type(
                        arg1)
