...
char** __fastcallsub_491400(char** arg1)
{
    ...
    if (arg1[2] != 0)
        sub_44e4d0(&ExceptionList, &data_5559b1, "pParseItem->pSubTree == NULL", 
            "c:\ax2017\engine\defparsetree.cpp", 0x43, "DefParseItemFree")
    ...
    sub_44e4d0(i_2, &data_5559b1, "IsPointerFromAllocator(pItem)", "c:\ax2017\engine\xalloc.h", 0x10c, 
        "XTypedAllocator<struct DefParseItem>::Free")
