// 函数名称: __libm_sse2_log_precise
// 虚拟地址: 0x53d760
// 源二进制: E:/torrent/Tools/Templetesgames/Shards.of.Infinity.Build.3805616.Win64.Public/steamapps/common/Shards of Infinity/Shards.exe.bndb

void*__libm_sse2_log_precise(int32_t arg1 @ mxcsr, int16_t arg2 @ x87control, int64_t arg3 @ xmm0)
{
    ...
    if ((arg1 & 0x7f80) == 0x1f80)
        ...
        if (eax_1.w == 0x7f)
            ...
            while (true)
                ...
                uint64_t xmm1_1[0x2] = data_59ec40
                uint64_t xmm3_1[0x2] = data_59eca0
                double xmm4_1[0x2] = data_59ec50
                uint64_t xmm6_1[0x2] = data_59ec60
                uint64_t xmm0_2[0x2] = _mm_or_pd(_mm_and_pd(xmm0, xmm1_1), xmm3_1)
                eax_3 = _mm_extract_epi16(_mm_add_pd(xmm4_1, xmm0_2), 0) & 0x7f0
                double xmm4_3[0x2] = *(eax_3 + 0x5a1330)
                xmm7_1 = (*(eax_3 + 0x5a1740)).q
                ...
                double xmm0_10 = var_8
                double xmm1_10[0x2] = _mm_cmpeq_sd(_mm_xor_pd(xmm1_1, xmm1_1), xmm0_10, 0)
                int64_t var_10
                
                if (_mm_extract_epi16(xmm1_10, 0) u> 0)
                    var_10 = -0x10000000000000
                    return sub_534d94(&var_8, &var_8, &var_10, 2)
                ...
                if ((ecx_1 & 0xfff) != 0)
                    ...
                    if ((ecx_1 & 0xfff) - 1 u> 0x7fe)
                        ...
                        if ((ecx_1 & 0x7ff) u>= 0x7ff)
                            ...
                            eax_9 = xmm2_6 | (_mm_srli_epi64(xmm2_6, 0x20) & 0xfffff)
                        ...
                        xmm1_10 = data_59ec40
                        uint64_t xmm2_3[0x2] = data_59eca0
                        uint32_t eax_6 = _mm_extract_epi16(
                            _mm_cmpeq_sd(xmm2_3, _mm_or_pd(_mm_and_pd(var_8, xmm1_10), xmm2_3), 0), 0)
                ...
                arg3 = xmm0_10 * 4503599627370496.0
                edx = 0xffffffcc
            ...
            double xmm2_1[0x2] = data_59ed00
            double xmm1_3[0x2] = _mm_mul_pd(data_59ecf0, xmm0_5)
            double xmm3_3 = _mm_mul_pd(xmm0_5, xmm0_5)
            double xmm1_4[0x2] = _mm_add_pd(xmm1_3, xmm2_1)
            double xmm2_2[0x2] = data_59ed10
            double xmm6_7[0x2] = _mm_mul_pd(xmm6_6, data_59ec70)
            uint64_t xmm4_5[0x2] = _mm_and_pd(xmm0_4, *(edx_1 + 0x59ec80))
