...
void* __convention("regparm")sub_4699b0(int32_t arg1, int32_t arg2, int32_t arg3, int32_t* arg4, int32_t arg5)
{
    ...
    if (arg3 != 0)
        ...
        if (edx u< data_5c99a4)
            ...
            if (*(arg1 + esi_1 + 0x1004) == arg3)
                void* ebx = edx * 0x1008
                int32_t ecx_1 = 0
                int32_t edx_1 = *(ebx + esi_1 + 0x75c)
                void* ebx_1 = ebx + esi_1
                int32_t* eax = *(ebx_1 + 0x758)
                
                if (edx_1 s> 0)
                    while (eax[1] != arg5 || *eax != &data_653bcc)
                        ecx_1 += 1
                        eax = &eax[6]
                ...
                label_469a2d:
                    ...
                    if (*(ebx_1 + 0x760) == 0)
                        *(ebx_1 + 0x758) = sub_45cff0(0x3000)
                        *(ebx_1 + 0x75c) = 0
                        *(ebx_1 + 0x760) = 0x200
                    
                    eax = sub_47b660(ebx_1 + 0x758)
