...
void* __fastcallsub_41ab60(void* arg1)
{
    ...
    if (ecx != 0)
        int32_t* eax = sub_41b1b0(ecx + 0x444, result)
        int32_t var_c_1 = 1
        eax[0x6d] = 1
        int32_t var_10 = *eax
        result = data_65aabc
                ...
                if (result != 0)
                    ...
                    if (edx_1 u< *(ecx_2 + 4))
                        ...
                        if (*(esi_2 + 0x48) == result)
                            int32_t var_1c_2 = 0xf42b0
                            sub_450c90(result, 8, esi_2 + 0x3c)
                            return sub_450a70(&var_10, 8, esi_2 + 0x3c, &var_10)
