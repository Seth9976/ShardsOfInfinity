// 函数名称: __libm_sse2_sin_precise
// 虚拟地址: 0x53e540
// 源二进制: E:/torrent/Tools/Templetesgames/Shards.of.Infinity.Build.3805616.Win64.Public/steamapps/common/Shards of Infinity/Shards.exe.bndb

double*__libm_sse2_sin_precise(int32_t arg1 @ mxcsr, int16_t arg2 @ x87control, double arg3 @ xmm0)
{
    ...
    if (not(cond:0))
        ...
        if (eax_2 u<= 0x10c5)
            ...
            *((((int.d(xmm1) + 0x1c7600) & 0x3f) << 5) + 0x5a0728)
            ...
            double xmm6[0x2] = data_59edf0
            double xmm5_2[0x2] = _mm_mul_pd(xmm5_1, xmm0_2)
            double xmm0_3[0x2] = _mm_mul_pd(xmm0_2, xmm0_2)
            double xmm2_3 = (*(0x5a0720 + (((int.d(xmm1) + 0x1c7600) & 0x3f) << 5))).q f+
                *((((int.d(xmm1) + 0x1c7600) & 0x3f) << 5) + 0x5a0738)
            ...
            double xmm5_3[0x2] = __addpd_xmmpd_mempd(xmm5_2, data_59ee00)
            *(0x5a0720 + (((int.d(xmm1) + 0x1c7600) & 0x3f) << 5))
            ...
            *((((int.d(xmm1) + 0x1c7600) & 0x3f) << 5) + 0x5a0728)
            *((((int.d(xmm1) + 0x1c7600) & 0x3f) << 5) + 0x5a0730)
