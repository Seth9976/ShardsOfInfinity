...
long doublesub_53ea80(int32_t arg1 @ mxcsr, int16_t arg2 @ x87control, double arg3)
{
    ...
    if (data_e4abb4 != 0)
        ...
        if (not(cond:0_1))
            ...
            int32_t xmm2[0x4] = data_59ef30
            uint64_t xmm0_1[0x2] = _mm_srli_epi64(xmm0, 0x34)
            int32_t eax_3 = xmm0_1
            int32_t xmm2_1[0x4] = _mm_sub_epi32(xmm2, __andpd_xmmxuq_memxuq(xmm0_1, data_59ef60))
            ...
            if ((eax_3 & 0x800) != 0)
                ...
                if (not(is_unordered.q(xmm0_3, xmm0_3)))
                    uint64_t xmm0_4[0x2] = _mm_cmpeq_pd(xmm0_3, xmm1_3, 1)
                    
                    if (eax_3 s< 0xbff)
                        return fconvert.t(__andpd_xmmxuq_memxuq(
                            __orpd_xmmxuq_memxuq(__cmppd_xmmpd_mempd_immb(xmm0_3, data_59ef50, 1), 
                                data_59ef50), 
                            data_59ef40))
                    
                    if (eax_3 s<= 0xc32)
                        return fconvert.t(xmm1_3 f- __andpd_xmmxuq_memxuq(xmm0_4, data_59ef20))
            else
                if (eax_3 s< 0x3ff)
                    return float.t(0)
    ...
    return sub_5328f0(var_30_1, 0xb, var_28_1)
}
