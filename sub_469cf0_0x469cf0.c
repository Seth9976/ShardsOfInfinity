...
void* __convention("regparm")sub_469cf0(int32_t arg1, int32_t arg2, int32_t arg3, int32_t* arg4, int32_t arg5)
{
    ...
    if (arg3 != 0)
        ...
        if (edx u< data_5c99a4)
            ...
            if (*(arg1 + edi_1 + 0x1004) == arg3)
                int32_t ecx_1 = 0
                void* edx_2 = edx * 0x1008 + edi_1
                int32_t* eax = *(edx_2 + 0x758)
                int32_t edx_3 = *(edx_2 + 0x75c)
                ...
                label_469d7a:
                    ...
                    if (*(edx_2 + 0x760) == 0)
                        *(edx_2 + 0x758) = sub_45cff0(0x3000)
                        *(edx_2 + 0x75c) = 0
                        *(edx_2 + 0x760) = 0x200
                    
                    eax = sub_47b660(edx_2 + 0x758)
                
                *eax = arg2
                eax[1] = arg5
                eax[2] = 3
                sub_44f510(&eax[3], arg4)
                return sub_4660e0(edx_2)
