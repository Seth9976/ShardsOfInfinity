...
int32_tsub_524da7(int32_t* arg1, int32_t arg2, char* arg3, char* arg4, int32_t arg5, char arg6)
{
    // 第一条实际指令: int32_t edi
    int32_t edi
    int32_t var_54 = edi
    ...
    if (__crt_strtox::input_adapter_character_source<class __crt_stdio_input::stream_input_adapter<wchar_t> >::validate(
        ...
        if (edi_1 == 0 || (edi_1 s>= 2 && edi_1 s<= 0x24))
            ...
            int32_t esi = 0
            int32_t ebx
            ebx.b = __crt_strtox::input_adapter_character_source<class __crt_stdio_input::stream_input_adapter<char> >::get(
                &arg_8)
            void var_48
            ...
            if (edi_1 == 0 || edi_1 == 0x10)
                ...
                if (eax_11 == 0)
                    char eax_14 = __crt_strtox::input_adapter_character_source<class __crt_stdio_input::stream_input_adapter<char> >::get(
                        &arg_8)
                    ...
                    if (eax_14 == 0x78 || eax_14 == 0x58)
                        ...
                        var_c_1 = __crt_strtox::input_adapter_character_source<class __crt_stdio_input::stream_input_adapter<char> >::get(
                            &arg_8)
                    else
                        if (edi_1 == 0)
                            edi_1 = 8
            ...
            while (true)
                ...
                label_524f9c:
                    ...
                    var_8_1 = eax_20 | 4
                eax_18, ecx_9 = __crt_strtox::input_adapter_character_source<class __crt_stdio_input::stream_input_adapter<char> >::get(
                    &arg_8)
                ecx_9.b = eax_18.b
                var_c_1 = ecx_9.b
